...
synthchat/
  ...
  templates/synthchat.html - SynthChat UI template (channels sidebar, agent list, files section, create-channel modal, schedules)
  static/app.js          - Frontend JS (channels, history, SSE live chat, mock demo, schedule sidebar, files sidebar, stop button, message queue)
  static/style.css       - Slack-like dark theme
  static/manifest.json   - PWA manifest
  static/sw.js           - Service worker for offline caching
  static/icon-192.png    - PWA icon (192x192)
  static/icon-512.png    - PWA icon (512x512)
