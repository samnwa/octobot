...
- **Tool Calling**: 6 tools (read_file, write_file, list_files, run_command, search_files, edit_file) with input_examples and deferred_loading metadata
- **Efficient Agent Loop**: Multi-turn tool calling with max 50 turns per conversation
- **Rich CLI**: Markdown rendering, syntax highlighting, thinking display, token tracking
- **Slash Commands**: /reset, /model, /tokens, /quit
