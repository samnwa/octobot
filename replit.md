...
- **Two Interfaces**: Web UI (Flask on port 5000, file browser sidebar, command menu, stop button, prompt queue with edit/delete/auto-run, in-progress file indicators, mobile responsive) and terminal CLI
